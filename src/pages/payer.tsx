          ...
          {!xrpAddress ? (
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg border border-gray-200 w-full">
              ...
              <div className="space-y-4">
                ...
                {/* Credential offer button: uses existing component and passes connected address */}
                <div className="pt-2">
                  <CredentialOfferButton
                    subjectAddress={xrpAddress}
                    label="Offer KYC credential to payer"
                  />
                </div>
              </div>
            </div>
