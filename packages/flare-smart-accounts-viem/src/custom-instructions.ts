...
import { abi as diddyAbi } from "./abis/DiddyAbi";
...
async function main() {
  ...
  const diddyContractAddress = "0x372e8721f95cc2A4c259CC636A7b7f1d3f252211";
  ...
  const welcomeMessage = await publicClient.readContract({
    address: diddyContractAddress,
    abi: diddyAbi,
